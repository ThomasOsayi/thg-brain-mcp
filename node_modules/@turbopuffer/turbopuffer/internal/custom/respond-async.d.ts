 ...
 * synchronous.
 */
import { type Turbopuffer } from "../../client.js";
import { type RequestClock } from "./performance.js";
...
export declare function prepareOptions(options: FinalRequestOptions): void;
export declare function maybePoll(client: Turbopuffer, response: Response, requestURL: string, options: FinalRequestOptions, clock: RequestClock): Promise<Response>;
//# sourceMappingURL=respond-async.d.ts.map