...
const RespondAsync = tslib_1.__importStar(require("./internal/custom/respond-async.js"));
...
class Turbopuffer {
    ...
    constructor({ baseURL = (0, env_1.readEnv)('TURBOPUFFER_BASE_URL'), apiKey = (0, env_1.readEnv)('TURBOPUFFER_API_KEY'), region = (0, env_1.readEnv)('TURBOPUFFER_REGION') ?? null, defaultNamespace = null, ...opts } = {}) {
        ...
        const customHeadersEnv = (0, env_1.readEnv)('TURBOPUFFER_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
        ...
        let response = await this.fetchWithTimeout(url, req, timeout, controller).catch(errors_1.castToError);
