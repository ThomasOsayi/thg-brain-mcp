...
import { AggregateBy, Filter, GroupBy, RankBy, RerankBy } from "./custom.mjs";
...
export declare namespace AttributeSchemaConfig {
    /**
...
export declare namespace BranchFromNamespaceParams {
    interface BranchFromNamespaceConfig {
        /**
         * The namespace to create an instant, copy-on-write clone of.
         */
...
export declare namespace CopyFromNamespaceParams {
    interface CopyFromNamespaceConfig {
        /**
         * The namespace to copy documents from.
         */
        source_namespace: string;
...
export declare namespace NamespaceMetadata {
    interface IndexUpToDate {
        status: 'up-to-date';
    }
    interface IndexUpdating {
        status: 'updating';
        /**
     ...
     * namespace.
     */
    interface Pinning extends NamespacesAPI.PinningConfig {
        /**
...
export declare namespace NamespaceRecallResponse {
